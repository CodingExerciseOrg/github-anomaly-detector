...
```bash
smee --url https://smee.io/xxxxxxxxx --target http://localhost:5000/webhook
```
...
4. (Optional) Set a **Secret** — copy it for the next step.
...
PORT=5000 WEBHOOK_SECRET=your_secret LOG_LEVEL=DEBUG python main.py
```

You should see:
```
INFO - Starting GitHub anomaly detector on port 5000
```
...
### Adding a new notifier (e.g. Slack, email)
